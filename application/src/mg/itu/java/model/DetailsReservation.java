...
public class DetailsReservation {
    ...
    public String getIdDetailsReservation() { return idDetailsReservation; }
    public void setIdDetailsReservation(String idDetailsReservation) { this.idDetailsReservation = idDetailsReservation; }
